...
/**
 * Fail-safe lightweight WebGL field inspired by the warm shadow / flow language
 * explored in GetLayers. If WebGL is unavailable or the GPU/context fails, this
 * component silently disables itself and the surrounding CSS/photography remains.
 */
    ...
    try {
      ...
      const fragmentSource = `
        ...
        void main() {
          ...
          vec2 mouse = u_mouse / max(u_resolution.xy, vec2(1.0));
          mouse.y = 1.0 - mouse.y;
      ...
      if (!resolutionLocation || !mouseLocation || !timeLocation) {
        gl.deleteProgram(program);
        gl.deleteShader(vertex);
        gl.deleteShader(fragment);
        canvas.style.display = "none";
        ...
        typeof IntersectionObserver !== "undefined"
          ? new IntersectionObserver(
              ([entry]) => {
                ...
                if (visible && !wasVisible && !reduceMotion && !disposed) {
