...
export default function TeraSection() {
  ...
  return (
    <section id="tera" ref={ref} className="relative py-24 md:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col gap-12 lg:gap-20">
          ...
          <motion.div
            ...
            className="order-1 relative aspect-[3/2] md:aspect-[16/9] lg:aspect-[21/9] overflow-hidden edge-fade-soft image-glow"
          >
            <Image
