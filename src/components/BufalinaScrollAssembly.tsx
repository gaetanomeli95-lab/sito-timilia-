...
export default function BufalinaScrollAssembly() {
  ...
  return createPortal(
    <div ref={scrubRef} className="relative h-[210vh] w-full sm:h-[240vh] lg:h-[340vh]">
      <div className="sticky top-[5svh] flex h-[90svh] w-full items-center justify-center sm:top-[6svh] sm:h-[88svh] lg:top-[8svh] lg:h-[84svh]">
        <div
          className="relative flex h-full w-full max-w-[34rem] items-center justify-center overflow-hidden bg-black shadow-[0_35px_90px_rgba(30,14,4,.22)] lg:ml-auto"
