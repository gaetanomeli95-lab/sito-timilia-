...
export default function HeroSection() {
  return (
    <section id="hero" className="relative h-[100svh] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-end h-full text-center px-6 pb-8 md:pb-20">
        <motion.div
        ...
        >
          Turno unico, posti limitati. Via Maqueda 221, Palermo.
        </motion.p>
      </div>
