...
/* Grana materica: carta, pietra, farina */
function Grain({ light = false }: { light?: boolean }) {
  return (
    <div
      aria-hidden
...
function Matter() {
  ...
  return (
    <section ref={ref} className="relative min-h-[100svh] overflow-hidden bg-[#2b312a] text-[#f4f1ea]">
...
function Blend() {
  return (
    <section
      className="relative overflow-hidden text-[#f4f1ea]"
